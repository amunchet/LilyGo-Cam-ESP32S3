NOTE:
WE ARE USING `MinimalCameraExample` - we have heavily modified it.
...
2. Install [Arduino ESP32](https://docs.espressif.com/projects/arduino-esp32/en/latest/), **ESP32 core version should be lower than V 3.0.0, 2.0.17 is recommended**
...
12. How to use ESPHome?
    - [esphome](https://github.com/Xinyuan-LilyGO/LilyGo-Cam-ESP32S3/tree/master/esphome)
